                ...
                switch (part.state) {
                  ...
                  case "input-streaming":
                    return (
                      ...
                      >
                        <div className="text-sm text-zinc-500">🌤️ Receiving weather request...</div>
                        <pre className="text-xs text-zinc-600 mt-1">{JSON.stringify(part.input, null, 2)}</pre>
                      </div>
                    );
                  ...
                  case "input-available":
                    return (
                      <div
                        ...
                        className="bg-zinc-800/50 border border-zinc-700 p-2 rounded mt-1 mb-2"
                      >
                        <div className="text-sm text-zinc-400">🌤️ Getting weather for {part.input.location}...</div>
                      </div>
                    );
